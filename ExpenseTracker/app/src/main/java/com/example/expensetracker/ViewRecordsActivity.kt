                ...
                bottomBar = {
                    ...
                    BottomAppBar(backgroundColor = Color.Transparent,
                        ...
                        content = {
                            ...
                            {
                                Text(
                                    text = "Add Expenses", color = Color.DarkGray, fontSize = 14.sp,
                            ...
                            {
                                Text(
                                    text = "Set Limit", color = Color.DarkGray, fontSize = 14.sp,
                                    textAlign = TextAlign.Center
                                )
                            }
                            ...
                            {
                                Text(
                                    text = "View Records", color = Color.DarkGray, fontSize = 14.sp,
                                    textAlign = TextAlign.Center
                                )
                            }
